...
def researcher_node(state: GraphState) -> GraphState:
    ...
    # ⛔ GUARD: si el intent real es diagrama, este nodo no debe hacer nada
    # (BUG-003: the old ASR guard that blocked RAG for asr intent was removed —
    # ASR generation benefits from grounding in architectural references.)
    if intent == "diagram":
