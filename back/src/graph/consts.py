...
prompt_researcher = (
    ...
    "You also have access to `video_RAG` to search in indexed architecture videos (tutorials, talks, patterns). "
    "IMPORTANT: When the user asks about architecture patterns, tactics, styles, or any architectural concept "
    "(e.g., CQRS, microservices, event sourcing, scalability), you SHOULD call `video_RAG` to include relevant video explanations. "
    "Video results provide valuable context with timestamps and examples from expert talks. "
