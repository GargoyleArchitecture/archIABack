...
class GraphState(TypedDict):
    ...
    language: Literal["en","es"]
    response_language: NotRequired[Literal["en","es"]]
    intent: Literal["general","greeting","smalltalk","architecture","diagram","asr","tactics","style"]
    force_rag: bool

    # Context contract v1
    context_contract_version: NotRequired[str]
    context_facts: NotRequired[dict]
    active_decisions: NotRequired[dict]
    turn_context: NotRequired[dict]
    pending_questions: NotRequired[list]
