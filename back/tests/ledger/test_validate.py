...
def _asr(id="asr_1", qa="latencia", status="active"):
    return {
        "id": id, "kind": "asr", "phase": "asr_table", "iteration": 1,
        "qa": qa, "parents": [],
...
def _style(id="sty_1", qa="latencia", asr_id="asr_1", status="active"):
    return {
        "id": id, "kind": "style", "phase": "style_table", "iteration": 2,
        "qa": qa,
...
def _tactic(id="tac_1", qa="latencia", asr_id="asr_1", sty_id="sty_1"):
    return {
        "id": id, "kind": "tactic", "phase": "tactics_table", "iteration": 3,
        "qa": qa,
        "parents": [
...
def test_forward_transition_with_skipped_phases_records_skip():
    """Jumping from intro to asr_table skips diagnosis; skipped_phases must list it."""
    L = empty_ledger("p", "u")
    t = {
        "from_phase": "intro", "to_phase": "asr_table", "iteration": 1,
        "triggered_by": "user_request", "user_message": "", "skipped_phases": ["diagnosis"],
        "timestamp": "2024-01-01T00:00:00Z",
    }
    validate_transition(L, t)  # no exception
...
def test_backward_transition_increments_iteration():
    """Going from style_table back to asr_table is allowed; iteration must still be current+1."""
    L = empty_ledger("p", "u")
    L["current_phase"] = "style_table"
    L["current_iteration"] = 2
    t = {
        "from_phase": "style_table", "to_phase": "asr_table", "iteration": 3,
...
def test_wrong_from_phase_raises():
    L = empty_ledger("p", "u")  # current_phase == intro
    t = {
        "from_phase": "asr_table", "to_phase": "style_table", "iteration": 1,
        "triggered_by": "user_request", "user_message": "", "skipped_phases": [],
        "timestamp": "2024-01-01T00:00:00Z",
    }
...
def test_wrong_iteration_raises():
    L = empty_ledger("p", "u")
    t = {
        "from_phase": "intro", "to_phase": "diagnosis", "iteration": 5,  # should be 1
        "triggered_by": "user_request", "user_message": "", "skipped_phases": [],
        "timestamp": "2024-01-01T00:00:00Z",
    }
